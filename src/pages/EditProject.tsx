...
const EditProject = () => {
  ...
  useEffect(() => {
    ...
    if (id) {
      const projectToEdit = sampleProjects.find(project => project.id === id);
      if (projectToEdit) {
        setFormData({
          ...
          isVideo: projectToEdit.isVideo || false,
        });
        setPreviewUrl(projectToEdit.imageUrl);
      } else {
        toast({
    ...
    <div className="min-h-screen p-6 md:p-10 bg-cream-light/50">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white p-6 md:p-8 rounded-lg shadow-md">
          <h1 className="font-playfair text-2xl font-bold mb-6">Edit Project</h1>
